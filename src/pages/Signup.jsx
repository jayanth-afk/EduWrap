...
export default function Signup() {
  ...
  const { signup, loginWithGoogle, loginWithGithub, loginWithApple, loginWithFacebook, isLoggedIn, error: authError, clearError } = useUser();
  ...
  return (
    ...
    >
      ...
      <p className="mt-6 text-center text-xs text-(--text-muted) leading-relaxed">
        By continuing, you agree to EduWrap's{' '}
        <Link to="/terms" className="text-(--text-secondary) underline hover:text-(--text-primary)">Terms of Service</Link>{' '}
        and{' '}
        <Link to="/privacy" className="text-(--text-secondary) underline hover:text-(--text-primary)">Privacy Policy</Link>.
      </p>
